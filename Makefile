...
_benchmark: ./test/benchmark.cpp
	$(CC) $(CFLAGS) $(OPTIMIZE_FLAGS) -o ./build/benchmark ./test/benchmark.cpp ./src/network/math.cpp

_net: ./src/main.cpp
	$(CC) $(CFLAGS) $(OPTIMIZE_FLAGS) -o ./build/net ./src/main.cpp ./src/network/math.cpp ./src/network/net.cpp ./src/mnist_reader.cpp 
